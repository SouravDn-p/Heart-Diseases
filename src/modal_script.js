    ...
    <div class="notebook-container">
      <div class="notebook-header">
        ...
        <div class="notebook-actions">
          <a href="https://github.com/SouravDn-p" class="btn" target="_blank">View on GitHub</a>
        </div>
      </div>
      <div id="notebook-content" class="notebook-content">
        <iframe 
          src="https://github.com/SouravDn-p" 
          width="100%" 
          height="700px" 
          frameborder="0"
...
└── vercel.json                    # Vercel configuration</code></pre>
    ...
    <div style="margin-top: 1.5rem;">
      <a href="github.com/SouravDn-pHeart-Disease-predictor" class="btn" target="_blank">View on GitHub</a>
      <a href="github.com/SouravDn-p" class="btn" target="_blank">Developer Profile</a>
    </div>
  `;
}
// ----- /Project Details -----
